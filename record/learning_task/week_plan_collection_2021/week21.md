 ...
 * @LastEditTime: 2021-05-30 19:49:34
 * @Description: 
-->
...
序号|计划|状态|备注
---|---|--|--
1. |深度学习 -> python 入门|1/4 完成|需要去看一下numpy和 plot 画图。基本已经满足需求
2. |深度学习 -> 深蓝的课程|半完成|作业还没有写
3. |理论补全 -> 凸优化|完成|完成 lecture 1-4 
4. |BASALT -> 代码阅读||
5. |杂项-> git使用精细化 bash 文件编写|半完成| bash文件编写还没有看
6. |ESKF -> ||
-----
