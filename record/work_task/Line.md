<!--
 * @Author: Liu Weilong
 * @Date: 2021-03-23 09:52:12
 * @LastEditors: Liu Weilong 
 * @LastEditTime: 2021-03-23 09:53:54
 * @FilePath: /Plan/work_task/Line.md
 * @Description: 
-->
### 线特征 work_record

Edgelet Common Line Vanishing


序号|自任务名|状态|备注
----|----|----|--
1. |Vertical-多帧匹配测试|半完成|如何确定描述子匹配的阈值还没有确认
2. |Vertical-KLT线端点光流+SAD/NCC匹配测试|半完成|a. ZNCC 的检测 StructVIO使用过<br>b. KLT光流追踪的感觉还可以，虽然也有误匹配的情况。但是对于角点的线，适应性比较好 SAD+NCC测试还没有做<br>
