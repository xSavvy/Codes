 ...
 * @LastEditTime: 2021-03-23 09:50:52
 * @Description: 
-->
### main task
...
2. |Vertical-KLT线端点光流+SAD/NCC匹配测试|半完成|a. ZNCC 的检测 StructVIO使用过<br>b. KLT光流追踪的感觉还可以 SAD+NCC测试还没有做<br>
...
15. |PL-SLAM 搬运-线特征check|完成|之前的问题是线特征之间存在误匹配，所以导致的问题
16. |PL-SLAM 搬运-内部匹配调整|完成|Stereo Matching、左右匹配参数(Disparity 大小、方向差值)、新旧匹配的参数(位置、端点pixel位置、长度check)、固定方差
17. |PL-SLAM 搬运-||