 ...
 * @LastEditTime: 2021-05-27 19:21:59
 * @Description: 
 */
...
int main()
{
    ...
    pcl::io::loadPCDFile("/home/lwl/sany_project/sany_agv_slam/lwl_test/200_1.pcd",*scan1);
    pcl::io::loadPCDFile("/home/lwl/sany_project/sany_agv_slam/lwl_test/200_2.pcd",*scan2);
